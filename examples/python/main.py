...
said = " ".join(sys.argv[1:]) or "أبي برجر دجاج وبطاطس، لا لا خله لحم"
...
if not agent_id:
    ...
    audio = voho("/v1/speech", {"text": "أهلاً بك في مطعم تشاركو، معك ليلى. تحب تطلب إيش؟", "voice": "layla", "model": "sada-1", "format": "mp3"}, raw=True)
...
out = voho("/v1/agents/%s/reply" % agent_id, {
    "text": said,
    "variables": {"company": os.environ.get("VOHO_COMPANY", "مطعم تشاركو")},
})
